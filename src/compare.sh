...
find "$BENCHMARK_FOLDER" -type f -name "*.smt2" | while read -r FILE; do
    ...
    echo "$FILE, $Z3_RESULT, $CVC5_RESULT, $Q3B_RESULT, $MYAPP_Z3_RESULT, $MYAPP_CVC5_RESULT" >> "$RESULTS_FILE"
    echo "$Z3_RESULT, $CVC5_RESULT, $Q3B_RESULT, $MYAPP_Z3_RESULT, $MYAPP_CVC5_RESULT"
done
